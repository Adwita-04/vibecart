        ...
        <div className='bg-white py-3 shadow-2xl px-4 md:px-0'>
            <div className='max-w-6xl mx-auto flex justify-between items-center'>
                ...
                <div className='flex gap-7 items-center'>
                    <Link to={'/'}><h1 className='font-bold text-3xl'><span className='text-fuchsia-600 font-serif text-5xl'>V</span>ibeCart</h1></Link>
                    <div className='md:flex gap-1 cursor-pointer text-gray-400 items-center hidden'>
